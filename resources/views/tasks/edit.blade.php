...
<head>
    ...
    <style>
        ...
        .completion-toggle.active .toggle-switch {
            background-color: #198754;
        }
        .completion-toggle.active .toggle-switch::after {
...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ url('/tasks') }}" method="POST" id="createTaskForm">
                            ...
                            <div class="mb-4">
                                <h5 class="fw-semibold mb-3 pb-2 border-bottom">
                                    <i class="fas fa-check-circle text-primary me-2"></i>Task Status
                                </h5>

                                <label class="completion-toggle {{ old('is_completed') ? 'active' : '' }}" 
                                       for="is_completed">
                                    <div class="d-flex align-items-center">
                                        <div class="me-3" style="font-size: 32px;">
                                            <i class="fas fa-check-circle"></i>
                                        </div>
                                        <div>
                                            <div style="font-weight: 600; font-size: 16px;">Mark as Completed</div>
                                            <div style="font-size: 13px; opacity: 0.8;">Toggle to mark this task as done</div>
                                        </div>
                                    </div>
                                    <input type="checkbox" 
                                           id="is_completed" 
    ...
    <script>
        ...
        completionCheckbox.addEventListener('change', function() {
            if (this.checked) {
                completionToggle.classList.add('active');
            } else {
                completionToggle.classList.remove('active');
            }
        });
    </script>
</body>
